/*
   ...
   Filename: valid.js
   Author: CPT 238 - Final Exam Project (Weston Richardson)
   Date:   7/31/2011
   ...
   validLengths()
      Validates that empty values have been entered for required fields
...
function validCNum() {
   ...
   else if (luhn(fv)==false) {
      isValid = false;
	document.getElementById("cnum").style.backgroundColor = "yellow";
   } else {
	document.getElementById("cnum").style.backgroundColor = "white";
   }
